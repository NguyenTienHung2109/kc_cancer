...
parser = ConfigParser()
parser.read('/work/hpc/iai/hungnt/kc_cancer/src/data/dataset/preprocess/lung.conf')
    ...
    def prepare_dataset(self):
        ...
        for patient in tqdm(self.IDRI_list):
            ...
            if len(nodules_annotation) > 0:
                ...
                print("patient_clean_dir_image:", patient_clean_dir_image)
