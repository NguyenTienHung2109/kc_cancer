...
class CaraNet(nn.Module):
    def __init__(self, channel, backbone):
        super().__init__()
...
if __name__ == '__main__':
    from src.models.components.pretrain import res2net101_v1b_26w_4s
    ras = CaraNet(channel=32, backbone=res2net101_v1b_26w_4s(pretrained=True))
    input_tensor = torch.randn(1, 1, 352, 352)

    outputs = ras(input_tensor)
