...
from src.models.seg.net import (UNet,
                                        UNetAttention,
                                        UNetPlusPlus)
...
class UNetModule(LightningModule):
    ...
    def model_step(
        ...
        """
        images, targets = batch["slice"], batch["seg_nodule"]
...
if __name__ == "__main__":
    ...
    print("root: ", root)
    config_path = str(root / "configs" / "model" / "seg")
    ...
    def main2(cfg: DictConfig):
        ...
        unet_plus_plus_module: UNetModule = hydra.utils.instantiate(cfg)
